...
export const VendorProfileList = () => {
                        ...
                        <Col md={9}>
                            ...
                            >
                                <Tab eventKey="home" title="User Info">
                                    ...
                                    <SharedButton onClick={handleCreateAccount} BtnLabel={"Create Vendor Profile"} BtnVariant={'light'} style={{ background: '#00285D' }} startIcon={<AddIconSvg/>}/>
                                    </div>
                                    <SearchPanel StartIcon={<IoSearch />} FormPlaceHolder={"Search by Name"} onChange={searchandler} />
                                    <VendorTableList pagination={pagination} maindata={maindata} actionHandler={actionHandler} pageHanlder={pageHanlder} />
                                </Tab>
                            </Tabs>
                        </Col>
                    </Row>
